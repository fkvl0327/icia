    ...
    <section id="section">
        <form action="Join" method="post">
            <div class="id">
                ...
                <span class="input__space"><input type="text" id="id" name="joinInfo" maxlength="10" title="ID" required></span>
                ${message}
            </div>
            <div class="pw">
                <h3 class="join__title"><label for="password">비밀번호</label></h3>
                <span class="input__space"><input type="password" name="joinInfo" maxlength="10" title="비밀번호 입력" required></span>
            </div>
            <div class="pw2">
                <h3 class="join__title"><label for="password2">비밀번호 재확인</label></h3>
                <span class="input__space"><input type="password" id="password" maxlength="10" title="비밀번호 재확인 입력" required></span>
            </div>
            <div class="name">
