...
<body onLoad="check()">
    ...
    <section id="section">
        ...
        <span onClick = "movePage(true)" ><button>Join</button></span>
        <span onClick = "movePage(false)" ><button>Previous</button></span>
    </section>
    <!-- Footer -->
    <footer id="footer">
...
function movePage(selection){
	...
	document.body.appendChild(form); //form을 jsp에 넣어준것이다.
	form.submit();

}

function check(){
	var param = "${paramValues.gInfo[0]}";
	var param1 ="${paramValues.gInfo[1]}";
	var param2 ="${paramValues.gInfo[2]}";
	alert(param);
	alert(param1);
	alert(param2);
}
