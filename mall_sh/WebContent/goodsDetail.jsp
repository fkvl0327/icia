<%@ page language="java" contentType="text/html; charset=UTF-8"
	            ...
	            <div id="goodsSummary" class="goodsinfo">
	                ...
	                <div id="option">
	                    ...
	                    <div class="option__select">
	                       ...
	                       <input type="button" value="+" class="opt" onclick="countI(this)">
	                       <input type="button" value="-" class="opt" onclick="countI(this)">
	                    </div>                                                                                                                        
	                </div>
	                <!-- 장바구니 | 구매하기 -->
    ...
    <script>
    function countI(plma){       
    	var count = Number(document.getElementsByName("opt")[0].value);
    	
    	if(plma.value== "+"){
    		count++;
    		document.getElementById("opt").value = count;
    		alert(document.getElementById("opt").value);
    	}else {
    		if(count <= 1){
    			alert("1보다 작을수는 없읍니다..");
    			alert("혹시.. 살 생각이 없는건가요?..");
    		}else{
    			count--;
    			document.getElementById("opt").value = count;
        		alert(document.getElementById("opt").value);
