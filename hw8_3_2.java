...
public class hw8_3_2 {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			System.out.println("'java hw8_3_2 1 학생이름' 입력 시 학생 한 명 성적 처리 프로그램 실행");
			System.out.println("'java hw8_3_2 2' 입력 시 학생 여러 명 성적 처리 프로그램 실행");
		} else if(args.length==1) {//여러 명 처리 프로그램
			String s=null, n1 =null, n2=null, n3=null;
			grade(s, n1, n2, n3);
		}
	...
	private static void grade(String s, String n1, String n2, String n3) {
		Scanner sc = new Scanner(System.in);
		...
		arr1[0][2] = n2;
		arr1[0][3] = n3;
		arr1[0][4] = Integer.toString(Integer.parseInt(n1)+Integer.parseInt(n2)+Integer.parseInt(n3));
		arr1[0][5] = Integer.toString(Integer.parseInt(n1)+Integer.parseInt(n2)+Integer.parseInt(n3)/3);
	...
	private static void arr1(String s, String n1, String n2, String n3) {
		System.out.println("===============================");
		System.out.println("[이름, 국어, 수학, 영어, 합계, 평균]");
		System.out.println(s+", "+n1+", "+n2+", "+n3+", "+Integer.parseInt(n1+n2+n3)+", "+Integer.parseInt(n1+n2+n3)/3);
	}
